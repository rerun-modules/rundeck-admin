...
## SYNOPSIS
    ...
    rerun [ARGS] rundeck-admin: [ apitoken-create | apitoken-list | apitoken-remove | jobs-archive | project-create | project-export | project-import | project-list | project-replicate | resource-add | resource-get | schedule-takeover | ssh-copy-id ] [OPTIONS]
