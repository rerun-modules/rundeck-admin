...
# Created: Thu May  8 11:08:01 PDT 2014
#
#/ usage: rundeck-admin:apitoken-remove  --user <admin>  --password <admin>  --token <>  --url <http://localhost:4440> 
...
rerun_options_parse() {
    ...
    [ -z "$TOKEN" ] && { echo >&2 "missing required option: --token" ; return 2 ; }
